...
@app.route('/api/questions/<int:group_id>/<int:month>/<int:year>/', methods=['GET'])
def get_questions_by_date_endpoint(group_id, month, year):
    return get_questions_by_date(group_id, month, year)
